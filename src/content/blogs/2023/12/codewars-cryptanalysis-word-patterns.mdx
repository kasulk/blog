...
Erst wandeln wir den String mit <ExternalLink href={docs.string.split}>`.split("")`</ExternalLink> in ein Array um. Dann können wir durch das Array loopen.

Weil wir genauso viele Elemente ändern/zurückgeben wollen wie drin sind, bietet sich hier <ExternalLink href={docs.array.map}>`.map()`</ExternalLink> an.
