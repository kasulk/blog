...
pubDate: 2024-05-03
description: Nach der Ernüchterung, dass ich beim Plasma abgelehnt wurde, weil meine Werte nicht optimal waren, hab ich aus Frust ein 6er Kata in 15 Minuten gelöst. Zugegeben, die Lösung viel mir ausnahmsweise mal leicht.
category: coden
tags:
...
Aber nichts desto trotz gefällt mir [meine Lösung](/blog/codewars-the-vowel-code) ziemlich gut. Und wenn man ein Ei gelegt hat, dann kann man ruhig mal gackern. 🐔

Kata [auf Codewars ankucken](https://www.codewars.com/kata/53697be005f803751e0015aa) oder [mit mir nachcoden](/blog/codewars-the-vowel-code).
