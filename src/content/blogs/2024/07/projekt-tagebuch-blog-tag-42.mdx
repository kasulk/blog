...
## Bilder global hinterlegen

Als nächstes hatte ich mir vorgenommen, Bilder global zu hinterlegen. Bisher hatte ich das Frontmatter so eingerichtet, dass man für jeden Blog-Post ein Bild hinterlegen kann.
