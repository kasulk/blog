...
|              |                                                                                                                       |
| ------------ | --------------------------------------------------------------------------------------------------------------------- |
| **Name:**    | <ExternalLink href={`${codewars.challenge.url}/${codingChallengeData.id}`}>{codingChallengeData.title}</ExternalLink> |
| **Level**:   | {codingChallengeData.level}                                                                                           |
| **Sprache**: | {codingChallengeData.language}                                                                                        |
...
<a
  href={`mailto:${email.questions}?subject=Frage zu ${codingChallengeData.platform} "${codingChallengeData.title}" (${codingChallengeData.language})`}
>
  Schreib mir!
</a>
